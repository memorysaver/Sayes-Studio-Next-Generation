		...
		<section className="py-16 bg-muted/30">
			<div className="container mx-auto max-w-6xl px-4">
				<div className="text-center mb-12">
					<h2 className="text-3xl font-bold tracking-tight mb-4">Bring Your Own Database</h2>
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						Database-agnostic setup with Drizzle ORM. Choose your preferred provider and get started
						quickly.
					</p>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-6 mb-8">
					{providers.map((provider) => (
						<Card key={provider.name} className="hover:shadow-lg transition-shadow">
							<CardHeader>
								<div
									className={`w-12 h-12 rounded-lg ${provider.color} flex items-center justify-center mb-3`}
								>
									{provider.icon}
								</div>
