			...
			<div className="container mx-auto max-w-6xl px-4">
				<div className="text-center mb-12">
					<div className="flex items-center justify-center gap-3 mb-4">
						...
						<h2 className="text-3xl font-bold tracking-tight">Payments with Polar</h2>
					</div>
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						Developer-focused payment infrastructure with subscription management, global coverage,
				...
				<div className="bg-muted rounded-xl p-6 mb-8">
					<div className="text-center space-y-4">
						...
						<p className="text-sm text-muted-foreground max-w-lg mx-auto">
							Built for developers and creators, Polar offers transparent pricing and powerful tools
							without hidden fees
						</p>
					</div>
				</div>
