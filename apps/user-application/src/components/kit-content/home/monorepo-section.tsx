import { FolderTree, Package, Zap } from 'lucide-react'
		...
		<section className="py-16">
			<div className="container mx-auto max-w-6xl px-4">
				<div className="text-center mb-12">
					<h2 className="text-3xl font-bold tracking-tight mb-4">Monorepo with PNPM Workspaces</h2>
				...
				<div className="grid md:grid-cols-3 gap-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>PNPM workspaces with efficient linking and caching</CardDescription>
						</CardHeader>
						<CardContent>
							<ul className="text-sm text-muted-foreground space-y-1">
